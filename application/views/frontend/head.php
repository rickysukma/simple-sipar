...
<html>
	<head>
		...
		<script type="text/javascript" src="<?php echo base_url() ?>assets/js/o-script.js"></script>
		<script type="text/javascript" src="<?php echo base_url() ?>assets/js/e-search.js"></script>
