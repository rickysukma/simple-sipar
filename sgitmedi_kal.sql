...
INSERT INTO `info_ads` (`idinfoads`, `idmaininfo`, `iduser`, `idcat`, `title`, `desc`, `address`, `telp`, `price`, `image`, `status`) VALUES
...
--
ALTER TABLE `info_ads`
  MODIFY `idinfoads` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
